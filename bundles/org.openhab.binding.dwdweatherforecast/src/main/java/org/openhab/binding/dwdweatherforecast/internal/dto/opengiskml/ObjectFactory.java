 ...
 * generated in the org.openhab.binding.dwdweatherforecast.internal.dto.opengiskml package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.openhab.binding.dwdweatherforecast.internal.dto.opengiskml
     */
    ...
    /**
     * Create an instance of {@link Kmlname }
     *
     * @param value
     *     Java instance representing xml element's value.
     */
    @XmlElementDecl(namespace = "http://www.opengis.net/kml/2.2", name = "name")
    public Kmlname createKmlname(String value) {
        return new Kmlname(value);
    }
